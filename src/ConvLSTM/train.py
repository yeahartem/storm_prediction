...
from src.ConvLSTM.models.WindCNN import WindNetPL
from src.ConvLSTM.models.models import ConvLSTM, WindNet
from src.ConvLSTM.datamodule import WindDataModule
import hydra
...
@hydra.main(version_base=None, config_path=os.path.join(os.getcwd(),"configs/train_configs"), config_name="train_world_reg_convlstm")
