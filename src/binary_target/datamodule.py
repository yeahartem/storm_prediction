...
def prepare_data(cfg):
    ...
    stations_list = get_stations(all_stations_data=cfg.path_to_weather_station_list,
                                 ...
                                 max_lat=cfg.rectangle_coords.lat_max,
                                 min_lat=cfg.rectangle_coords.lat_min,
                                 max_lon=cfg.rectangle_coords.lon_max,
                                 min_lon=cfg.rectangle_coords.lon_min,
    ...
    dataset_as_xarray = xr.open_mfdataset(climate_file_paths,  combine="by_coords", parallel=True, engine='scipy')
